...
from gaussed.linops import LinearOp, SumOp
...
class GaussianLikelihood:
    ...
    def laplace_or_ep_condition(self, gp: GP, F: ProbeLike, y: Array) -> PosteriorGP:
        raise NotImplementedError("Only non-Gaussian likelihoods must implement laplace_or_ep_condition.")

    # ---------- direct mv helper (TODO: keep?) ----------
