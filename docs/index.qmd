...
* **SED-first design.** Sequential Experimental Design is not an afterthought; the abstractions (operators, probes, backends) make active learning/BO-style loops natural.
...
* **JAX-first, minimal deps.** Pure JAX, pytree-registered, fully JIT/`vmap`-friendly. (Use **Optax** for optimisation if you like; it’s optional.)
...
* **Pure JAX rebuild** end-to-end (no Equinox dependency).
